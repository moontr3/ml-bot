...
MAX_CHARS_IN_HISTORY = 5000 # Maximum amount of characters in AI history
MAX_MESSAGE_LEN = 512 # Maximum amount of characters allowed in a single message in AI history
...
HANGUP_TEXTS = [
    ...
    f'{AI_ERROR} пожалуй нет',
    f'{AI_ERROR} ой ошибочка произошла как так',
    f'{AI_ERROR} ну все пизда бьем тревогу',
    f'{AI_ERROR} а это с заказчиком согласовано?',
    f'{AI_ERROR} я, конечно, благодарен вашему подарку ввиде кучки говна, но вынужден отказаться',
    f'{AI_ERROR} афк бб',
]
...
# "Bold" versions of numbers for use in discord presence
UNICODE_COOL_NUMBERS = {
    "9": "𝟵",
    "8": "𝟴",
    "7": "𝟳",
    "6": "𝟲",
